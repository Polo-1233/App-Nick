 ...
 */
function computeCurrentPhaseCycle(arpConfig, nowIso) {
 ...
 */
export function buildHomeScreenPayload(output, ctx) {
...
function computeFallback(onset5cycle) {
 ...
 */
export async function getHomeScreenPayload(client, userId) {
