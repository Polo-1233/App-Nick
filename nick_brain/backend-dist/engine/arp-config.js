 ...
 */
export function generateARPConfig(arpTime, now) {
 ...
 */
export function isInCRPWindow(timeHHMM, config) {
 ...
 */
export function cyclesFromFormula(actualSleepOnset, wakeTime) {
    if (!actualSleepOnset || !wakeTime)
        return null;
 ...
 */
export function wakeVarianceMinutes(wakeTimes) {
...
//# sourceMappingURL=arp-config.js.map