 ...
 */
import { fetchRecentSleepLogs, fetchUpcomingCalendarEvents, fetchRecentLifeEvents, fetchActiveWeeklyBalance, fetchWeeklySummaries, } from "../db/queries.js";
export async function checkProactiveTriggers(client, userId) {
    const triggers = [];
    try {
