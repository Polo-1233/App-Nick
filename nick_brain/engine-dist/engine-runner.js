...
import { generateCandidateRecommendations, applyRecommendationCap, } from "./recommendation-engine.js";
import { computeToneOverride, applySuppressionRules, applyConflictToneAdjustments, shouldShowCycleCount, shouldShowDeficitWarning, } from "./conflict-resolution.js";
const ENGINE_VERSION = "1.0.0";
// ─── Validation Gates ─────────────────────────────────────────────────────────
function validateGates(ctx) {
...
export function runEngine(ctx) {
    ...
    const resolvedCtx = { ...ctx, arp_config: arpConfig };
    ...
    const weeklyAccounting = computeWeeklyAccounting(weekSleepLogs, weekDailyLogs, dayNumber);
    ...
    const ctxForDetection = { ...resolvedCtx, weekly_balance: freshBalance };
 ...
 */
export function runEngineSafe(ctx) {
    try {
...
//# sourceMappingURL=engine-runner.js.map